...
The following javascript code shows how to use [BWS.Blockchain.Save](https://github.com/blockchain-web-services/docs.bws.ninja/blob/master/solutions/bws.blockchain.save) to write "Hello World!" to the mumbai blockchain network using the `save` operation.
...
* If your call is synchronous, the `info` part will contain the call result values.<div data-gb-custom-block data-tag="hint" data-style='info'>**API RESPONSE EXAMPLE**
