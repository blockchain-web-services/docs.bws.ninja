---
description: We take care of everything.
---
...
Interacting with blockchain requires paying fees, so it's important to understand how Blockchain Web Services manages those fees to offer our customers the best user experience.
...
* Once you move into subscription mode by entering your credit card details,
  ...
  * Every solution requires $BWS tokens to execute and fund the developer's community and platform maintenance. Please read the platform [White Paper](https://www.bws.ninja/white-paper) to know more about the $BWS token and its tokenomics.
...
```javascript
100 IPFS Images, included    = 0 USD
100 NFTs x 0.02 Network Fee  = 2 USD                                
```

Your next bill will show an extra 2 USD to your monthly plan.

## How do I pay those Fees?

To check your current monthly cost, go to the Billing menu and check your credit usage.

{% hint style="info" %}
**BLOCKCHAIN CREDIT FEE**\
\
We use the Blockchain Credit Fee as the minimum billable unit, 0.01 USD. If, for example, you spend 2 USD creating NFTs, we will add 200 blockchain credit fee units to your next bill.
{% endhint %}
