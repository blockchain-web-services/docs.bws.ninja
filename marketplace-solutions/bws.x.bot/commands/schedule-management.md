[Home](../README.md) > [Commands](README.md) > Schedule Management
...
- [Calendar &amp; Time](calendar-and-time.md) - Manage calendar settings and time periods for report generation cycles.
