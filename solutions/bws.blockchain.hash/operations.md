...
### Curl ExampleThis operation is asynchronous.\\

Once executed, check the results using [fetch API](../../api-how-tos/main-api-methods/fetch-api-method.md) and the provided`jobId.`

{% tabs %}
{% tab title="curl" %}
\`\`\`powershell curl --location 'https://api.bws.ninja/v1/call'\
\--header 'X-Api-Key: API-KEY'\
\--header 'Content-Type: application/json'\
\--data '{ "solution": "BWS.Blockchain.Hash", "version": 1, "network": "matchain", "operation": "insert", "parameters": { "key": "my patient id", "value": "my patient data" } }'
...
| parameters<mark style="color:red;">\*</mark> | JSON   | <p>check <a href="operations.md#method-parameters"><strong>Method Parameters</strong></a></p><p></p> |<div data-gb-custom-block data-tag="tabs"><div data-gb-custom-block data-tag="tab" data-title='200 Returns the related job Id'><pre class="language-json"><code class="lang-json"><strong>{
...
</code></pre></div></div>### Method Parameters
...
### Curl Example<div data-gb-custom-block data-tag="hint" data-style='info'>This operation is asynchronous.\
Once executed, check the results using [fetch API](../../api-how-tos/main-api-methods/fetch-api-method.md) and the provided`jobId.`</div><div data-gb-custom-block data-tag="tabs"><div data-gb-custom-block data-tag="tab" data-title='curl'>```powershell
